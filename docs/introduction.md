...
The Pan-Canadian Genome Library (PCGL) Molecular Data Submission Workflow is a Nextflow-based pipeline that **simplifies and automates** the submission of molecular genomics data to the PCGL repository.
